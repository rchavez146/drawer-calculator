document.addEventListener('DOMContentLoaded', () => {
    ...
    function calculateDepositAmount() {
        const depositAmount = drawersData.reduce((acc, drawer) => acc + drawer.capturedAmount || 0, 0);
    ...
    function createDrawerElement(drawer, index) {
        ...
        captureBtn.addEventListener('click', () => {
            drawer.capturedAmount = drawer.totalAmount; // Capture the current total amount
